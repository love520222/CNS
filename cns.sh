...
#Make cns start cmd
Config() {
	[ -n "$cns_install_directory" ] && return  #Variables come from the environment
...
InstallFiles() {
	...
	$download_tool_cmd cns http://pros.cutebi.taobao69.cn:666/cns/${cns_UPX}/linux_${machine} || Error "cns download failed."
